...
public class ControllerIntegration {
	...
	void createJogadorIntegrationTest() throws JSONException {
		...
		Jugador jogador1=new Jugador(4,"Isa",new java.util.Date(7/1/2022));
		...
		HttpEntity<Jugador> request = new HttpEntity<Jugador>(jogador1, headers);
	...
	void modificaNomJogadorIntegrationTest() throws JSONException {
		...
		Jugador jogador1=new Jugador(4,"Ana",new java.util.Date(7/1/2022));
...
//				+ "}";
	...
	void borrarTiradasIntegrationTest() throws JSONException {
		...
		Jugador jogador1=new Jugador(1,"Isabel",new java.util.Date(13/1/2022));
